...
const Hero = () => {
  return (
    <div className="mb-8 lg:mb-32 md:max-w-[1240px] w-[90vw] m-auto md:h-[800px] h-[400px] relative mt-2 flex justify-center md:items-center items-start">
      <BackgroundImage
        imageUrl={hero}
        className={`rounded-lg absolute h-full`}
